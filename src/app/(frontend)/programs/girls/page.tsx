    ...
    <div>
      <section className="bg-gradient-to-br from-emerald-800 to-emerald-950 py-16 text-white">
        <div className="mx-auto max-w-4xl px-4 text-center">
          <h1 className="text-4xl font-bold">Girls In Tennis</h1>
          <p className="mt-3 text-emerald-100">
            A program led by girls for girls — inspiring and empowering the next generation.
          </p>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-4xl px-4">
          ...
          <div className="mb-8 rounded-xl border border-purple-100 bg-purple-50 p-5">
            <p className="text-sm text-purple-800">
              <strong>Coach Lily Clerf</strong> — Tennis Canada certified instructor Lily Clerf leads
              a team of female coaches as they teach and empower the next generation of female tennis
              players.
            </p>
          </div>
